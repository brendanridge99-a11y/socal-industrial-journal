...
Cast a WIDE NET. Include articles about:

**Economics & Markets (macro-level):**
- Federal Reserve policy, interest rates, inflation, GDP, unemployment
- Stock market trends, bond yields, financial markets
- Oil/energy prices, commodity markets
- Banking sector, credit conditions, lending standards
- Economic forecasts, recession indicators

**Business & Corporate (broad):**
- Major corporate deals, M&A, IPOs, bankruptcies
- Retail sector news (Amazon, Walmart, Target, etc.)
- E-commerce trends and growth
- Tech company expansions or layoffs
- Manufacturing and production trends

**Supply Chain & Trade (global to local):**
- Port congestion, shipping costs, container rates
- Trade policy, tariffs, international commerce
- Nearshoring, reshoring, manufacturing shifts
- Trucking, rail, air freight
- Warehouse automation and robotics

**Policy & Infrastructure:**
- California regulations, zoning, environmental rules
- Infrastructure bills, transportation funding
- Labor laws, minimum wage, union activity
- Tax policy affecting businesses or real estate

**Real Estate (any sector):**
- Commercial real estate investment trends
- REIT activity and performance
- Construction costs, materials pricing
- Any industrial, warehouse, logistics, or distribution news
- Office-to-industrial conversions
- Land sales, development projects

**Local Southern California:**
- Any IE/LA/OC/SD business, real estate, or economic news
- Major employers expanding or contracting
- Local infrastructure projects
- Regional economic data

DO NOT be overly restrictive. If an article is about economics, business, trade, logistics, real estate, or major corporate activity, include it. Brokers can decide relevance themselves.

Categorize each article into ONE of these:
- economics: Fed policy, interest rates, inflation, macro trends, oil/energy prices, financial markets, banking
- industries: Any real estate sector news, cap rates, construction, leasing, investment sales, REITs, development
- business: Corporate deals, M&A, earnings, retail, e-commerce, manufacturing, major companies
- tech: AI, automation, robotics, supply chain tech, e-commerce platforms, logistics innovation
- politics: Government policy, regulations, infrastructure, trade policy, tariffs, labor law, zoning
- supply-chain: Ports, shipping, freight, transportation, trade flows, nearshoring, logistics, warehousing
- local-deals: IE/LA/OC/SD specific business, real estate, or economic news
