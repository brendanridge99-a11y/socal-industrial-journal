    ...
    try:
        ...
        return {
            ...
            "settings": {
                ...
                "sources": ["Bloomberg", "Wall Street Journal", "Green Street", "Connect CRE", "BisNow", "CoStar", "GlobeSt", "Supply Chain Dive", "Inland Valley Daily Bulletin", "San Bernardino Sun", "IE Business Daily", "San Diego Business Journal", "Reuters", "Los Angeles Times", "Daily Bulletin", "Los Angeles Daily News", "Press-Telegram", "San Gabriel Valley Tribune", "Whittier Daily News", "The Sun", "The Press-Enterprise", "Redlands Daily Facts", "Pasadena Star-News", "Orange County Register", "Daily Breeze", "San Diego Union-Tribune"],
...
- Inland Valley Daily Bulletin (dailybulletin.com)
- San Bernardino Sun (sbsun.com)
- IE Business Daily (iebusinessdaily.com)
- San Diego Business Journal (sdbj.com)
- Reuters (reuters.com)
- Reuters California News (reuters.com/world/us/california)
- Los Angeles Times (latimes.com)
- Daily Bulletin (dailybulletin.com)
...
- The Sun - San Bernardino (sbsun.com)
- The Press-Enterprise - Riverside (pe.com)
- Redlands Daily Facts (redlandsdailyfacts.com)
- Pasadena Star-News (pasadenastarnews.com)
- Orange County Register (ocregister.com)
- Daily Breeze - South Bay (dailybreeze.com)
...
'''
    ...
    def _base_score(article):
        ...
        if source in ['wall street journal', 'bloomberg', 'wsj', 'reuters']:
            ...
            score += 30
        elif source in ['los angeles times']:
            score += 30
        elif source in ['supply chain dive']:
            score += 20
        elif source in ['inland valley daily bulletin', 'san bernardino sun', 'ie business daily',
...
<footer class="site-footer">
  ...
  <div class="footer-sources">Bloomberg &nbsp;·&nbsp; Reuters &nbsp;·&nbsp; Wall Street Journal &nbsp;·&nbsp; Green Street &nbsp;·&nbsp; Connect CRE &nbsp;·&nbsp; BisNow &nbsp;·&nbsp; CoStar &nbsp;·&nbsp; GlobeSt &nbsp;·&nbsp; Supply Chain Dive &nbsp;·&nbsp; LA Times &nbsp;·&nbsp; OC Register &nbsp;·&nbsp; SD Union-Tribune &nbsp;·&nbsp; Press-Enterprise &nbsp;·&nbsp; Daily Bulletin &nbsp;·&nbsp; LA Daily News &nbsp;·&nbsp; Press-Telegram &nbsp;·&nbsp; SGV Tribune &nbsp;·&nbsp; The Sun &nbsp;·&nbsp; Daily Breeze &nbsp;·&nbsp; Redlands Daily Facts &nbsp;·&nbsp; Pasadena Star-News &nbsp;·&nbsp; Whittier Daily News &nbsp;·&nbsp; SD Business Journal &nbsp;·&nbsp; IE Business Daily</div>
