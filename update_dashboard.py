    ...
    def generate_category_page(cat_key, cat_title):
        ...
        if count == 0:
            ...
            for article in arts:
                ...
                body = f'Hi%20Brendan%2C%0A%0AI%20would%20like%20more%20information%20on%20the%20following%20article%3A%0A%0A{article["headline"]}%0A{article_url_encoded}%0A%0AThanks'
                access  = f'&nbsp;&nbsp;<a href="mailto:{YOUR_EMAIL}?subject={subject}&body={body}" style="font-family:\'Jost\',sans-serif;font-size:0.72rem;font-weight:500;color:var(--accent);text-decoration:none;letter-spacing:0.05em;">Request more info →</a>' if is_paywalled else ''
