    ...
    if os.path.exists(ARTICLES_FILE):
        ...
        return {
            ...
            "settings": {
                ...
                "sources": ["Bloomberg", "Wall Street Journal", "Green Street", "Connect CRE", "BisNow"],
...
<body>
    ...
    <div style="background: #000; color: #666; padding: 2rem; text-align: center; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; font-size: 0.75rem; border-top: 3px solid #c8102e;">
      ...
      <div style="margin-bottom: 0.75rem;">Bloomberg • Wall Street Journal • Green Street • Connect CRE • BisNow</div>
